// Auth store — Supabase session + profile role. The Orders terminal signs in
// with an existing staff/kitchen/admin account (RLS: read orders/items,
// advance workflow status). Customers are rejected.
  ...
  refreshProfile: async () => {
    ...
    if (!STAFF_ROLES.includes(role)) {
      ...
      set({
        ...
        userId: null,
        role: null,
        error: 'This account does not have order access.',
      });
      return;
    }
